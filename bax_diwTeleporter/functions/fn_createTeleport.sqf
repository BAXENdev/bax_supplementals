...
params [["_pos", [0, 0, 0]], ["_recieverId", 0], ["_senderId", 0], ["_onTeleportCode", {}]];

_trigger = createTrigger ["EmptyDetector", _pos];
_trigger setVariable ["diwako_anomalies_main_cooldown", false, true];
_trigger setVariable ["diwako_anomalies_main_senderID", _senderId, true];
...
["diwako_anomalies_main_setTrigger", [
    ...
    [
		...
		"[thisTrigger, thisList] call bax_diwTeleporter_fnc_activateTeleport",
		""
	]
