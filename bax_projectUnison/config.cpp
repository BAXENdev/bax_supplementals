...
class CfgPatches {
    class BAX_ProjectUnison {
        name = "BAXEN's Project Unison Adjustments";
        author = "BAXENATOR";
        units[] = {};
        requiredVersion = 1.0;
        requiredAddons[] = {"E11_Uniforms", "E11_Helmets", "E11_Vests"};
...
// Uniforms
    ...
    class E11_HR_WG_TRUETIMBER_BLK: ItemCore {
        class ItemInfo: UniformItem {
            mass = 20;
            containerClass = "Supply60";
        };
